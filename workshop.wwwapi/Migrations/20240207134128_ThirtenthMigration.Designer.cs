...
namespace workshop.wwwapi.Migrations
{
    ...
    [Migration("20240207134128_ThirtenthMigration")]
            ...
            modelBuilder.Entity("workshop.wwwapi.Models.DatabaseModels.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DoctorId = 1,
                            PatientId = 1,
                            Booking = new DateTime(2024, 2, 8, 13, 41, 28, 12, DateTimeKind.Utc).AddTicks(1271)
                        },
                        new
                        {
                            DoctorId = 2,
                            PatientId = 2,
                            Booking = new DateTime(2024, 2, 9, 13, 41, 28, 12, DateTimeKind.Utc).AddTicks(1308)
                        });
                });
