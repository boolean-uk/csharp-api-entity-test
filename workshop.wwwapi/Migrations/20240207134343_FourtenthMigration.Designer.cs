...
namespace workshop.wwwapi.Migrations
{
    ...
    [Migration("20240207134343_FourtenthMigration")]
            ...
            modelBuilder.Entity("workshop.wwwapi.Models.DatabaseModels.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DoctorId = 1,
                            PatientId = 1,
                            Booking = new DateTime(2024, 2, 8, 13, 43, 42, 999, DateTimeKind.Utc).AddTicks(8776)
                        },
                        new
                        {
                            DoctorId = 2,
                            PatientId = 2,
                            Booking = new DateTime(2024, 2, 9, 13, 43, 42, 999, DateTimeKind.Utc).AddTicks(8793)
                        });
                });
