...
namespace workshop.wwwapi.Repository
{
    public class Repository : IRepository
    {
        ...
        public async Task<Appointment> GetAppointmentById(int doctorid, int pasientid)
        {
            return await _databaseContext.Appointments.FirstOrDefaultAsync(a => a.DoctorId == doctorid && a.PatientId == pasientid);
        }
